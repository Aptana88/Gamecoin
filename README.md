...
main	Production – Contient uniquement le code de la dernière version en ligne.	Stable et Déployable
develop	Développement – Branche d'intégration principale. Toutes les nouvelles fonctionnalités (feature/) y sont fusionnées.

🛠️ Branches de Support (Courte Durée)
Ces branches sont créées à partir de develop (ou main pour les hotfix) et sont supprimées après la fusion.
